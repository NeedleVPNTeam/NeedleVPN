<div align="center">
  ...
  <p>
    <a href="https://github.com/GreenFlagTeam/GreenFlag-VPN/releases/tag/GreenFlagVPN">
...
Приглашайте друзей по вашему персональному коду из раздела **Профиль → Реферальная программа**. За **каждого** приглашенного друга, оплатившего подписку на любой период, вы получите **30 дней бесплатно** на свой аккаунт. Код находится в приложении, там же есть кнопка «Поделиться».

## Системные требования

- Android 7.0 (API 24) или новее
- ARM-процессор (armeabi-v7a или arm64-v8a) — подходит для всех современных телефонов
...
<div align="center">
  <img src="docs/1.png" alt="GreenFlag" width="80"/>
  <br/>
  <sub>Сделано с любовью для тех, кто ценит свободу интернета</sub>
</div>
